    ...
    <body>
        ...
        <div class="container-fluid bg-light py-3 my-3 mt-0">
            <div class="container text-center animated bounceInDown">
                <h1 class="display-1 mb-4">Pricelist</h1>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 px-4">
                        <div class="card" >
                            <div class="card-body text-dark">
                              <h4 class="card-title text-center">Pricelist {{ $loop->iteration }}</h4>
                              <p>{{ $item->detail }}</p>
                              <a href="{{ Storage::disk('s3')->url($item->path) }}" class="btn btn-primary w-100">Download</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
